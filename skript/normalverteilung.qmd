# Die Normalverteilung {#sec-normalverteilung}
...
## ein Würfel
```{python}
#| fig-alt: "Häufigkeitsverteilung der Ergebnisse eines Würfels."
...
## zwei Würfel
```{python}
#| fig-alt: "Häufigkeitsverteilung der Ergebnisse von zwei Würfeln."
...
## drei Würfel
```{python}
#| fig-alt: "Häufigkeitsverteilung der Ergebnisse von drei Würfeln."
...
## 3 Klassen
```{python}
#| fig-alt: "Häufigkeitsverteilung der Zahnlänge mit 3 Klassen"
...
## 5 Klassen
```{python}
#| fig-alt: "Häufigkeitsverteilung der Zahnlänge mit 5 Klassen"
...
```{python}
#| fig-alt: "Häufigkeitsverteilung der Zahnlänge mit 7 Klassen"
...
```{python}
#| echo: false
#| fig-alt: "Grafische Darstellung der Quantilfunktion. Für einen Wert q ist die Position unter der Glockenkurve eingezeichnet. Die Bereiche links und rechts davon sind farblich unterschiedlich gefüllt."
