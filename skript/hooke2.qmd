...
## Zusammenfassung
**to do:** (studentisierte) z-Werte sind hilfreich, um einzelne abweichende Werte zu identfizieren. Sind viele oder die ganze Messreihe fehlerhaft, reicht dies jedoch nicht aus. 

Die grafische Darstellung von Messwerten ist sehr viel aussagekräftiger.