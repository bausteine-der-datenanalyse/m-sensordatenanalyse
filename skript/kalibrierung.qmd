...
# anderes Verfahren: lineare Regression mit x der wahre Wert und y der Messwert
lm_verfahren = poly.polyfit(x = [messgröße[x1], messgröße[x2]], y = [messwerte[x1], messwerte[x2]], deg = 1)
print(50 * '=')
print(lm_verfahren)
...
Ein Beispiel: **hierhier: Testweise Anstieg 2 genommen und schon klappt der Nullpunktfehler nicht mehr**
```{python}
# Daten erzeugen
messgröße = np.arange(0, 11) * 2 + 7
messwerte = messgröße + 4 - messgröße / 3
